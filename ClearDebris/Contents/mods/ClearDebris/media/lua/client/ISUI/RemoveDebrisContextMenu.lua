...
local function addRemoveDebrisMenu(player, context, worldobjects)
    ...
    if not (inventory:containsTypeRecurse("HandShovel") or inventory:containsTypeRecurse("HandFork") or inventory:containsTypeRecurse("Shovel") or inventory:containsTypeRecurse("Shovel2") or inventory:containsTypeRecurse("GardenHoe") or inventory:containsTypeRecurse("GardenFork")) then return end
