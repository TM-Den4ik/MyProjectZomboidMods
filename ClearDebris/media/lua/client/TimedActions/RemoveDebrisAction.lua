...
function RemoveDebrisAction:isValid()
	...
	return (playerInv:contains("HandShovel") or playerInv:contains("HandFork") or playerInv:contains("Shovel") or playerInv:contains("Shovel2") or playerInv:contains("GardenHoe") or playerInv:contains("GardenFork"));
end
