...
function RemoveDebrisCursor:create(x, y, z, north, sprite)
	...
	local item = inventory:getFirstTypeEvalRecurse("HandShovel", predicateNotBroken) or inventory:getFirstTypeEvalRecurse("HandFork", predicateNotBroken) or inventory:getFirstTypeEvalRecurse("Shovel", predicateNotBroken) or inventory:getFirstTypeEvalRecurse("Shovel2", predicateNotBroken) or inventory:getFirstTypeEvalRecurse("GardenHoe", predicateNotBroken) or inventory:getFirstTypeEvalRecurse("GardenFork", predicateNotBroken);
...
function RemoveDebrisCursor:isValid(square)
	...
	local tools = playerInv:contains("HandShovel") or playerInv:contains("HandFork") or playerInv:contains("Shovel") or playerInv:contains("Shovel2") or playerInv:contains("GardenHoe") or playerInv:contains("GardenFork")
